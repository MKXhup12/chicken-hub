...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=12693508525"
...
Main2:AddToggle("Skill Z",true,function(a)
	...
	Main2:AddSeperator(" Soul Guitar ")

Main2:AddToggle("Auto Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
if World2 then
		Teleport2:AddButton("TP Flower Red",function()
...
Misc1:AddToggle("Anti AFK",true,function(value)
 _G.AFK = value
 end)
